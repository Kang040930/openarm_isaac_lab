...
from .. import mdp
from ..mdp.actions import MaskedJointPositionActionCfg
...
@configclass
class OpenArmMultiBlockPickPlaceEnvCfg(PickPlaceEnvCfg):
    def __post_init__(self):
        ...
        self.actions.right_arm_action = MaskedJointPositionActionCfg(
            asset_name="robot",
            side="right",
            joint_names=[
        ...
        self.scene.object_1 = _CUBE_CFG.copy()
        self.scene.object_1.prim_path = "{ENV_REGEX_NS}/Object_1"

        self.scene.object_2 = _CUBE_CFG.copy()
        self.scene.object_2.prim_path = "{ENV_REGEX_NS}/Object_2"

        self.scene.object_3 = _CUBE_CFG.copy()
        self.scene.object_3.prim_path = "{ENV_REGEX_NS}/Object_3"
...
@configclass
class OpenArmMultiBlockPickPlaceEnvCfg_PLAY(OpenArmMultiBlockPickPlaceEnvCfg):
    def __post_init__(self):
        super().__post_init__()
